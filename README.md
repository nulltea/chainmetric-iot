...
| 📷                      | Sensor                             | Interface           | Metrics                | Driver                                       |
| :---------------------- | :--------------------------------- | :------------------ | :--------------------- | :------------------------------------------- |
| ![analog hall image][]  | [Hall Effect][analog hall]         | Analog with I²C ADC | ![magnetism badge][]   | [Custom implementation][analog hall driver]  |
| ![analog mic image][]   | [Microphone][analog mic]           | Analog with I²C ADC | ![noise level badge][] | [Custom implementation][analog mic driver]   |
| ![analog piezo image][] | [Piezoelectric film][analog piezo] | Analog with I²C ADC | ![vibration badge][]   | [Custom implementation][analog piezo driver] |
| ![analog mq9 image][]   | [Gas (MQ-9)][analog mq9]           | Analog with I²C ADC | ![lpg badge][]         | [Custom implementation][analog mq9 driver]   |
| ![analog flame image][] | [Flame detector][analog flame]     | Analog with I²C ADC | ![flame badge][]       | [Custom implementation][analog flame driver] |
